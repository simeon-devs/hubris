...
| T-28 | Real dataset ingestion + calibration (EVENT DAY) | 7 Event | A | DONE |
| T-29 | Baseline validation + sensitivity + sanity checks | 7 Event | A/D | DONE |
...
- DONE — Sims — 2026-08-05 — "The QComm reproduction (2.04 vs 2.04) and the crisis reproducing as an engine result are the strongest validation we have." Follow-ups ordered: constrained frontier (realism constraints, configurable), fixed-cost re-weighting to stated monthly volumes + committed reconciliation artifact, demo re-seed from the real twin (QComm crisis).
