...
/**
 * CLASSIC — the pre-integration Command view, preserved in full at /classic
 * (nothing lost by the AtlasVision home page). Full-bleed twin plus scenario
 * chips, KPI strip, Andon alerts, and the Kaizen ledger.
 */
...
export default function ClassicCommandPage() {
  const {
    kpis,
    simResult,
    savedScenarios,
