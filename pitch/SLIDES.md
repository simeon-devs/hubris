# SLIDES — EMX ATLAS (4 slides, demo carries the rest)
...
## Slide 3 — the machine (shown during the AI beat)

**The maths computes. The AI explains. Neither crosses the line.**

`Your data → validated twin → 12 what-ifs + 4 analyses → answers, verified`

- Every answer's numbers **checked against the solver's output** before you see them
- Unverifiable number → **flagged, by name** — never shown as fact
- Measured without the check: an invented figure in **3 of 5 answers**
